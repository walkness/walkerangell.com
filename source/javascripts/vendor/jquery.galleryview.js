...
(function (jQuery) {
	...
	*/		
	GalleryView = {
		...
		setDimensions: function() {
			...
			jQuery.each(this.gvImages,function(i,img) {
		...
		buildFilmstrip: function() {
			...
			jQuery.each(dom.gv_frames,function(i,frame) {
		...
		initImages: function() {
			var self = this,
				dom = this.dom;
			jQuery.each(this.gvImages,function(i,gvImage) {
				var img = jQuery('<img/>');
		...
		showItem: function(i) {
			...
			switch(this.opts.panel_animation) {
				case 'crossfade':
					dom.gv_panels.eq(this.iterator).fadeOut(this.opts.transition_speed,function(){jQuery(this).remove();});
				...
				case 'slide':
					...
					dom.gv_panels.eq(this.iterator).animate(
						{ left: oldPanelEnd },
						{ duration: this.opts.transition_speed, easing: this.opts.easing, complete: function(){ jQuery(this).remove(); } }
					);
					break;
				default:
					dom.gv_panels.eq(this.iterator).remove();
		...
		init: function(options,el) {
			...
			this.opts = jQuery.extend({},jQuery.fn.galleryView.defaults,options);
			this.el = el;
			this.$el = jQuery(el);
			this.id = el.id;
			...
			jQuery.each(this.elems,function(i,elem) {
				var elem = elem.split('.');
	...
	/*
		MAIN PLUGIN CODE
	*/
	jQuery.fn.galleryView = function (options) {
		if (this.length) {
	...
	*/
	jQuery.fn.galleryView.defaults = {
