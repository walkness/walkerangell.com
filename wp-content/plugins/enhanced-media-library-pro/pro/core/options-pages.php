...
/**
 *  wpuxss_eml_extend_taxonomies_option_page
 *
...
add_action( 'wpuxss_eml_extend_taxonomies_option_page', 'wpuxss_eml_extend_taxonomies_option_page' );

function wpuxss_eml_extend_taxonomies_option_page() { 
    ?>
