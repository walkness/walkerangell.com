...
$free_eml_plugin = 'enhanced-media-library/enhanced-media-library.php';

if ( isset( $all_plugins[$free_eml_plugin] ) ) 
{
    if ( version_compare( $all_plugins[$free_eml_plugin]['Version'], '2.0.4', '<' ) ) 
    {
        if ( is_plugin_active( $free_eml_plugin ) ) 
        {
...
if ( version_compare( $wp_version, '4.0', '>=' ) ) {
    ...
    register_activation_hook( __FILE__, 'wpuxss_eml_pro_on_activation' );
}
